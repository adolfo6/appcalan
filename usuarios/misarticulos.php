						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav mr-auto">
								<li class="nav-item active"><a class="nav-link"
									href="../index.php">Articulos en general<span
							...
							<a href="editarperfil.php"> <span class="all-tittles"> <h2> 
...
<!--Fin de buscador-->
		...
		<div class="row margen">
			<div class="col-md cabeza5">
				<ul>
					<a href="subirarticulo.php" class="btn btn-primary">Subirartículo</a>
				</ul>
					...
					<div class="col-md-12 subar">
						...
						<div class="card mb-3" style="max-width: 540px;">
							<div class="row no-gutters">
								<div class="col-md-4">
									<img src="../img/ejemplo2.jpeg" class="card-img"
										...
										<div class="modal fade" id="exampleModalLong" tabindex="-1"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">Muy buen artículo solamente que el tamaño de la imagen no es el indicado.</div>
													<div class="modal-footer">
													<li class="nav-item"><a class="btn btn-secondary" href="cons.php">Modificar</a></li>
				...
				<div class="row margenadministrararticulo">
					<div class="col-md-12 subar">
						...
						<div class="card mb-3" style="max-width: 540px;">
							<div class="row no-gutters">
								<div class="col-md-4">
									<img src="../img/ejemplo3.jpg" class="card-img"
										alt="imagen no encontrada"/>
								</div>
								<div class="col-md-8">
									<div class="card-body">
				...
				<div class="row margenadministrararticulo">
					<div class="col-md-12 subar">
						...
						<div class="card mb-3" style="max-width: 540px;">
							<div class="row no-gutters">
								<div class="col-md-4">
									<img src="../img/ejemplo4.jpg" class="card-img"
										alt="imagen no encontrada"/>
								</div>
								<div class="col-md-8">
									<div class="card-body">
				...
				<div class="row margenadministrararticulo">
					<div class="col-md-12 subar">
						...
						<div class="card mb-3" style="max-width: 540 px;">
							<div class="row no-gutters">
								<div class="col-md-4">
									<img src="../img/ejemplo5.jpg" class="card-img"
										alt="imagen no encontrada"/>
								</div>
								<div class="col-md-8">
									<div class="card-body">
				...
				<div class="row margenadministrararticulo">
					<div class="col-md-12 subar">
						<div class="card mb-3" style="max-width: 540px;">
							<div class="row no-gutters">
								<div class="col-md-4">
									<img src="../img/ejemplo6.jpg" class="card-img"
										alt="imagen no encontrada"/>
								</div>
								<div class="col-md-8">
									<div class="card-body">
