				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item " href="conocimientosgenerales.php">Conocimientos
							...
							especializados</a> <a class="dropdown-item " href="tialavanguardia.php">TI
							a la vanguardia</a> <a class="dropdown-item " href="noticiasyeventos.php">Noticias
							y eventos TIC</a>
					</div></li>
