					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item active"
								href="conocimientosgenerales.php">Conocimientos generales
								...
								class="dropdown-item " href="noticiasyeventos.php">Noticias
								y eventos TIC</a>
						</div>
					</li>
		...
		<div class="row margen">
			...
			<div class="col-md-6 articulo">
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/nuevo.jpg" width="auto" height="170"
				...
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/nuevo1.jpg" width="auto" height="170"
								class="card-img-top" alt="No se pudo Encontrar el Artículo"/>
							<div class="card-body">
								<h5 class="card-title">Artículo</h5>
								<p class="card-text">Aquí va un resumen breve del artículo.</p>
				...
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/alienware.jpg" width="auto" height="170"
								class="card-img-top" alt="No se pudo Encontrar el Artículo"/>
							<div class="card-body">
								<h5 class="card-title">Artículo</h5>
								<p class="card-text">Aquí va un resumen breve del artículo.</p>
			...
			<div class="col-md-6 articulo">
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/gabi.jpg" width="auto" height="170"
								class="card-img-top" alt="No se pudo Encontrar el Artículo"/>
							<div class="card-body">
								<h5 class="card-title">Artículo</h5>
								<p class="card-text">Aquí va un resumen breve del artículo.</p>
				...
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/procesador.jpg" width="auto" height="170"
								class="card-img-top" alt="No se pudo Encontrar el Artículo"/>
							<div class="card-body">
								<h5 class="card-title">Artículo</h5>
								<p class="card-text">Aquí va un resumen breve del artículo.</p>
				...
				<div class="row margen">
					<div class="col-md-11 subar">
						<div class="card1" style="width: auto; height: auto;">
							<img src="../img/fibra.jpg" width="auto" height="170"
								class="card-img-top" alt="No se pudo Encontrar el Artículo"/>
							<div class="card-body">
								<h5 class="card-title">Artículo</h5>
								<p class="card-text">Aquí va un resumen breve del artículo.</p>
